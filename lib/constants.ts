...
export const SYSTEMS: SystemData[] = [
  {
    ...
    face: 'Sans- Zajuma_Priv_Fintech.png',
  ...
  },
  {
    ...
    face: 'Sans- Modjaji_KEL_Agrotech.png',
  ...
  },
  {
    ...
    face: 'Sans- Amun_Mezzo_Legacy_deeptech.png',
...

  {
    ...
    face: 'Sans- Osiris_Omega_Health_Tech.png',
  ...
  },
  {
    ...
    face: 'Sans- Set_Sia_Subconcious_Governance.png',
...

  {
    ...
    face: 'Sans- Thoth_KEV_Edtech.png',
    ...
    applications: [
      {
        name: 'KEV Core',
        description: 'The core KEV learning platform — 185+ subjects with AI-personalized paths, mentorship, and progress analytics. The web app is primary; native desktop and mobile clients are on the way — join the notification list to hear the moment each one ships.',
  ...
  },
  {
    ...
    face: 'Sans- Sekhmet_Strategic_Defence.png',
  ...
  },
  {
    ...
    color: '#164e63',
    darkColor: '#083344',
    description: '1000+ threat detection agents protecting against advanced cyber threats.Restricted.',
    ...
    badge: { text: '⚠️Restricted', tone: 'danger' },
    features: [
  ...
  },
  {
    ...
    face: 'Sans- Ptah_Construction.png',
    ...
    applications: [
      ...
      },
      {
        ...
        description: 'Ptah Real Estates is live now at ptahrealty.sansmercantile.com — property development and portfolio management on Ptah rails: site sourcing, valuation telemetry, development tracking, and handover in one place. Mobile clients are on the way; join the notification list to hear the moment each one ships.',
        icon: 'Sans- Ptah_Construction.png',
        liveUrl: 'https://ptahrealty.sansmercantile.com',
        platforms: ['web', 'ios', 'android'],
        platformUrls: { web: 'https://ptahrealty.sansmercantile.com' },
  ...
  },
  {
    ...
    face: 'Sans- Ra_Stellar_Minerals_and_Clean_Power.png',
  ...
  },
  {
    ...
    face: 'Sans- Shango_Wind_Geothermal_and_Atmospheric_Sciences.png',
  ...
  },
  {
    ...
    face: 'Sans- Anansi_Primo_Temporal_Science.png',
  ...
  },
  {
    ...
    color: '#000000',
    darkColor: '#1a1a1a',
    description: 'Interstellar travel system enabling space colonization with advanced propulsion and life support for deep space exploration.Restricted.',
