      ...
      <div className="min-h-screen bg-gradient-to-b from-nexus-dark via-[#0f1425] to-nexus-dark pt-32 pb-24">
        <div className="max-w-5xl mx-auto px-6">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="mb-12">
            <h1 className="text-5xl font-bold text-white mb-6">MPeti Autonomous Developer</h1>
          ...
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.4 }} className="bg-white/5 backdrop-blur-sm rounded-xl p-8 border border-white/10">
            <h2 className="text-3xl font-semibold text-white mb-6">Autonomous Evolution</h2>
            <p className="text-gray-300 mb-4">
              MPeti represents the pinnacle of autonomous software development, capable of self-improvement
              and adaptation to new programming paradigms and technologies.
            </p>
            <p className="text-gray-300">
              <strong>Note:</strong> Self-learning algorithms and autonomous development methodologies have been redacted.
            </p>
          </motion.div>
        </div>
      </div>
