...
export default function MamiWaterPage() {
  return (
    <Layout>
      <div className="min-h-screen bg-gradient-to-b from-nexus-dark via-[#0f1425] to-nexus-dark pt-32 pb-24">
        <div className="max-w-5xl mx-auto px-6">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="mb-12">
            <h1 className="text-4xl font-bold text-white mb-6">Mami Water - Hydraulics & Ocean Systems</h1>
            <p className="text-xl text-gray-300">Intelligent ocean monitoring, marine conservation, and sustainable water resource management.</p>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.4 }} className="bg-white/5 backdrop-blur-sm rounded-xl p-8 border border-white/10">
            ...
            <p className="text-gray-300 text-lg">Mami Water provides intelligent ocean monitoring and marine conservation, protecting our seas while enabling sustainable resource management.</p>
          </motion.div>
        </div>
      </div>
    </Layout>
