  ...
  const sections = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'SIA Archetypal Intelligence', slug: 'systems/sia', time: '5 min read' },
        { name: 'KEV Educational Vectors', slug: 'systems/kev', time: '5 min read' },
        { name: 'Primo Temporal Manipulation', slug: 'systems/primo', time: '5 min read' },
        { name: 'MF Music AI', slug: 'systems/mf', time: '5 min read' },
        { name: 'MPeti Autonomous Developer', slug: 'systems/mpeti', time: '5 min read' },
        { name: 'Nexus Integration Hub', slug: 'systems/nexus', time: '5 min read' },
        { name: 'Quantum Financial Modeling', slug: 'systems/quantum', time: '5 min read' },
        { name: 'Bio-Enhancement Systems', slug: 'systems/bio', time: '5 min read' },
        { name: 'Climate Prediction Networks', slug: 'systems/climate', time: '5 min read' },
        { name: 'Autonomous Manufacturing', slug: 'systems/manufacturing', time: '5 min read' },
        { name: 'Space Resource Management', slug: 'systems/space', time: '5 min read' },
        { name: 'Neural Interface Technology', slug: 'systems/neural', time: '5 min read' },
        { name: 'Predictive Analytics Engine', slug: 'systems/analytics', time: '5 min read' },
        { name: 'Distributed Computing Grid', slug: 'systems/distributed', time: '5 min read' },
        { name: 'Ethical AI Governance', slug: 'systems/ethical', time: '5 min read' },
      ]
    },
    {
