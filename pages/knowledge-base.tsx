  ...
  const categories = [
    {
      ...
      icon: '🚀',
      articles: [
        { title: 'Quick Start Guide', href: '/docs/sdk', readTime: '4 min read' },
        { title: 'Account Setup', href: '/docs', readTime: '3 min read' },
        { title: 'Dashboard Overview', href: '/docs', readTime: '4 min read' },
        { title: 'First Integration', href: '/docs/integration', readTime: '5 min read' },
      ],
    },
    {
      title: 'System Guides',
      icon: '🧩',
      articles: [
        { title: 'Priv Wealth Intelligence', href: '/docs/sdk', readTime: '5 min read' },
        { title: 'KEL Agricultural Systems', href: '/docs', readTime: '5 min read' },
        ...
        { title: 'Anubis Verification', href: '/docs', readTime: '5 min read' },
        { title: 'Omega Medical AI', href: '/docs', readTime: '5 min read' },
      ],
    },
    {
      ...
      articles: [
        ...
        { title: 'REST API Reference', href: '/docs/integration', readTime: '4 min read' },
        { title: 'WebSocket Connections', href: '/docs/integration', readTime: '4 min read' },
        { title: 'Rate Limiting', href: '/docs/integration', readTime: '4 min read' },
        { title: 'Error Handling', href: '/docs/integration', readTime: '4 min read' },
      ],
    },
    {
      ...
      icon: '🔒',
      articles: [
        { title: 'Data Encryption', href: '/docs/compliance', readTime: '4 min read' },
        { title: 'HIPAA Compliance', href: '/docs/compliance', readTime: '4 min read' },
        { title: 'SOC 2 Certification', href: '/docs/compliance', readTime: '4 min read' },
        { title: 'Privacy Policy', href: '/docs', readTime: '4 min read' },
        { title: 'Regulatory Updates', href: '/docs/compliance', readTime: '4 min read' },
      ],
    },
    {
      ...
      icon: '🔗',
      articles: [
        { title: 'Webhook Configuration', href: '/docs/integration', readTime: '4 min read' },
        { title: 'Database Integration', href: '/docs/integration', readTime: '4 min read' },
        { title: 'Payment Processing', href: '/docs/integration', readTime: '4 min read' },
        { title: 'Third-party Services', href: '/docs/integration', readTime: '4 min read' },
        { title: 'Custom Workflows', href: '/docs/integration', readTime: '4 min read' },
      ],
    },
    {
      ...
      icon: '🔧',
      articles: [
        { title: 'Common Issues', href: '/docs', readTime: '3 min read' },
        { title: 'Performance Optimization', href: '/docs', readTime: '4 min read' },
        { title: 'Debugging Guide', href: '/docs', readTime: '4 min read' },
        { title: 'Support Resources', href: 'mailto:support@sansmercantile.com', readTime: '3 min read' },
        { title: 'FAQ', href: '/docs', readTime: '3 min read' },
      ],
    },
  ];
