...
const networkPlaceholders = [
  {
    ...
    embed: '<iframe width="100%" height="594" src="https://www.youtube.com/embed/videoseries?list=PLecIy_-i6Lm8lMwM5cxijiWZOzFsQd_Qa&autoplay=1&mute=1&loop=1" title="Sans Mercantile YouTube Playlist" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>',
  },
  {
    id: 'facebook-1',
    platform: 'Facebook',
